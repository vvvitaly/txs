...
final class SberComplexTransfer implements MessageParserInterface
{
    ...
    /**
     * @var \vvvitaly\txs\Sms\Parsers\Sber\ComplexTransfer\MessagesStorageInterface
     */
    private $storage;

    /**
     * @var \vvvitaly\txs\Sms\Parsers\Sber\ComplexTransfer\PinSmsParserInterface
     */
    private $pinSmsParser;

    /**
     * @var \vvvitaly\txs\Sms\Parsers\Sber\ComplexTransfer\TransferSmsParserInterface
     */
    private $transferSmsParser;

    /**
     * @param \vvvitaly\txs\Sms\Parsers\Sber\ComplexTransfer\MessagesStorageInterface $storage
     * @param \vvvitaly\txs\Sms\Parsers\Sber\ComplexTransfer\PinSmsParserInterface $pinSmsParser
     * @param \vvvitaly\txs\Sms\Parsers\Sber\ComplexTransfer\TransferSmsParserInterface $transferSmsParser
     */
    public function __construct(
        MessagesStorageInterface $storage,
        PinSmsParserInterface $pinSmsParser,
        TransferSmsParserInterface $transferSmsParser
    ) {
     ...
     */
    private function createBill(TransferPinMessage $pinMessage, TransferMessage $transferMessage): Bill
    {
